            ...
            <Container>
              ...
              <Form onSubmit={(e) => editProduct(e)}>
                ...
                <Form.Group
                  as={Row}
                  className="mb-3"
                  controlId="formHorizantalQuantity"
                >
                  <Form.Label column sm={2}>
                    Qunatity:
                  </Form.Label>
                ...
                <Form.Group
                  as={Row}
                  className="mb-3"
                  controlId="formHorizantalDescription"
                >
                  <Form.Label column sm={2}>
                    Description:
                  </Form.Label>
                ...
                <Form.Group as={Row} className="mb-3">
                  <Col sm={{ span: 10, offset: 2 }}>
                    ...
                    <Button
                      variant="dark"
                      className="deleteButton mt-4  px-4 py-3"
                      onClick={()=>delprod(id)}
                    >
                      Delete Product
                    </Button>{" "}
