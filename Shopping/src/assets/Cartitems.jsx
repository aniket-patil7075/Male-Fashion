...
function Cartitems() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const response = await fetch("https://male-fashion-pj3d.onrender.com/api/orders/createorder", {
        method: "POST",
        headers: {
                      ...
                      <tr key={c._id}>
                        <td>
                          <img
                            ...
                            src={`https://male-fashion-pj3d.onrender.com/api/product/getphoto/${c._id}`}
                            alt=""
                            height={100}
                            width={100}
                          />
